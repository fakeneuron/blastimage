...
3. **Link & load** — in blastimage, **🔗 Link imagegen** (paste the folder's absolute path once; works in any browser) then **↻ Load round** to ingest the batch into the review UI.
