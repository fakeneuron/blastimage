/**
 * blastimage — imagegen folder read seam (BI-024.1)
 *
 ...
 * and reads `rounds/r<N>/batch.json` plus on-disk images. Write/export lives
 * in the BI-021.2 section of `storage.ts`; this module is the read counterpart.
 */
